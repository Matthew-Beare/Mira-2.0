...
- **PR:** `#73`
- **Merge candidate authority:** resolve the exact live PR #73 head directly from GitHub immediately before CI and merge. Do not edit this file again before merge merely to record the head.
