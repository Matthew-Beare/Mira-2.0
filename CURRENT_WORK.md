...
- **PR:** `#73`
- **Merge candidate authority:** resolve the exact live PR #73 head directly from GitHub immediately before CI and merge. No further pre-merge documentation edits are required.
