...
- **PR:** `#73`
- **Merge candidate authority:** resolve the exact live PR #73 head directly from GitHub immediately before CI and merge. Do not make another documentation-only commit merely to record that SHA.
