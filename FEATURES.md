...
- `DEV-008` | Continuous idea/backlog capture audit requiring every materially new product idea, feature, workflow, requirement or implementation-discovered capability to be linked to existing canonical feature/work IDs or added to FEATURES/BACKLOG with explicit lifecycle/dependency disposition, plus repeated checkpoint/merge audit so uncaptured ideas cannot silently disappear or expand the active packet | required/governance | specified | DEV-001,DEV-002,DEV-003,DEV-005,DEV-007
...
- G19 Machine-readable feature catalog, work lifecycle, packet alignment, idea capture audit and CI drift enforcement | DEV-005,DEV-007,DEV-008,DEV-001,DEV-003,g-19 | stable-id/generated-projection+packet-alignment+idea-capture-audit+lifecycle-reconciliation
