...
class AndroidOwnershipFixture:
    def __init__(self) -> None:
        ...
        self.provider_main = self.root / "android-client/provider/src/main/java/com/example/provider"
        self.tests = self.root / "android-client/core/src/test/java/com/example"
        self.provider_tests = self.root / "android-client/provider/src/test/java/com/example/provider"
    ...
    def add_provider_component(self) -> tuple[str, str]:
        source_path = "android-client/provider/src/main/java/com/example/provider/Bridge.java"
        test_path = "android-client/provider/src/test/java/com/example/provider/BridgeTest.java"
...
class AndroidCodeOwnershipTests(unittest.TestCase):
    ...
    def test_rejects_unowned_android_source(self) -> None:
        ...
        with self.assertRaisesRegex(AndroidCodeOwnershipError, "unowned Android production artifacts"):
            fixture.validate()
    ...
    def test_rejects_root_and_roots_together(self) -> None:
        ...
        with self.assertRaisesRegex(AndroidCodeOwnershipError, "production_root or production_roots"):
            fixture.validate()
    ...
    def test_rejects_java_test_without_direct_class_reference(self) -> None:
        ...
        with self.assertRaisesRegex(AndroidCodeOwnershipError, "no direct Java verification reference"):
            fixture.validate()
