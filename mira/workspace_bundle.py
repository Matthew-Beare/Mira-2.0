...
_PROTOCOL_MARKERS = (
    ...
    "resource_types_json` contains `appointment`, `appointment_provider`, and `calendar_projection`",
    ...
    "authority_binding/binding-appointment-provider",
    "authority_binding/binding-appointment",
    "authority_binding/binding-calendar-projection",
    ...
    "exact_text_sha256",
    "raw_file_sha256",
    "normalized_extraction_sha256_v1",
    "Do not ask the user to calculate or paste a hash.",
    "Calendar projection remains downstream from canonical appointment capture.",
    "## Canonical tasks",
