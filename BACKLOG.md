...
- `APPOINTMENT-IDENTITY-001` is the one active work packet in `M2-M0-021`; it is bounded to provider-neutral canonical provider + appointment identity/reconciliation and does not include evidence extraction, provider Calendar writes, reminder scheduling, outbound email or medical interpretation.
