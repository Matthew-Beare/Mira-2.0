...
- `SHOP-CORE-001` is completed by PR #72 at `b02e723396c4deb16394c59c7`; exact-head CI `33347846273`, post-merge `main` CI `33347884489`, direct/release tests and fresh isolated Google create/replay/receipt-line fulfillment/receipt-immutability proof are durable evidence.
- `GROCERY-CORE-001` is completed by PR #73 at `a906fdd0e64dc661774fc7530007030dd1249522`; exact-head CI `33355952138` and post-merge `main` CI `33355975328`, direct/release tests and fresh isolated Google exact-name/observed-descendant/quantity-honesty zero-write proof are durable evidence.
