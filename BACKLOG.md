...
- `CALENDAR-PROJECTION-001` is now explicitly split. `CALENDAR-PROJECTION-001A` is the one active work packet in `M2-M0-022`; real provider capability/readback proof remains `CALENDAR-PROJECTION-001B`.
