...
- `APPOINTMENT-INTAKE-001` is active in `M2-M0-024` and provider-neutral implementation/test evidence is green on PR #79 head `5992a57db91697decc5e95d20ecd76df3adc3eec`, CI `33457016348`: 366 Python tests and 30 Apps Script tests passed. This proves the intake/reconciliation contract and synthetic Calendar handoff only; Gmail fetching, image/model extraction infrastructure, real provider Calendar write/readback, reminders, and outbound provider contact remain separate evidence/work.
