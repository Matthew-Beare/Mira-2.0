...
- `GROCERY-CORE-001` is completed by PR #73 at `a906fdd0e64dc661774fc7530007030dd1249522`; exact-head CI `33355952138`, post-merge `main` CI `33355975328`, direct/release tests and fresh isolated Google exact-name/observed-descendant/quantity-honesty zero-write proof are durable evidence.
- `BACKUP-CORE-001` is completed by PR #74 at `10a8c43084ae75703a197ce7ea2f0cda734fca04`; exact-head CI `33369577945`, post-merge `main` CI `33369639977`, direct/release tests and fresh isolated Google zero-source-write current-Resource export/fresh-target revision parity proof are durable evidence. Event history, original idempotency history, provider archive, encryption, retention/scheduling and disaster-recovery guarantees remain explicitly outside v1.
