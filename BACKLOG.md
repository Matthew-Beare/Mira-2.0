...
| `GROCERY-CORE-001` | PREREQUISITE | Grocery-list versus stock reconciliation. | SHOP-001,INV-001,LOC-001 | active in `M2-M0-019` / PR #73; direct grocery tests and release guards green through CI `33349090500` on `ad32344c97013f2cc370cd887b1e59934b7f8452`; fresh isolated Google exact-name/observed-descendant/quantity-honesty zero-write proof verified; candidate-unmerged pending final exact-head CI/merge |
...
- `GROCERY-CORE-001` is the one active work packet in `M2-M0-019` / PR #73; direct grocery tests and release guards are green through CI `33349090500`, fresh isolated Google proof verified exact-name observed-descendant classification, honest unknown current quantity despite acquisition quantity 12, and zero canonical writes; merge/post-merge verification is still pending.
