...
- `ASSET-IDENTIFIER-001` is the one active packet. It implements `IDENT-001` as a separate identifier authority over existing immutable asset UUIDs and explicitly stops before OCR, fitment inference, movement, inventory location and Android scanning.
