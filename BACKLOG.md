...
- The audited onboarding interview remains preserved as semantic/source evidence. `FIRSTBOOT-CORE-001` is now complete; post-four progressive discovery is owned by `DISCOVERY-CORE-001`/`ONBOARD-004`.
