...
| 6a | `FEATURE-ALIGN-001` | HARDENING | Implement `DEV-007` packet-to-feature alignment and product-lifecycle verification, including generated feature/work projection, completed-work filtering and session alignment verified. | DEV-007,DEV-005,DEV-002,DEV-003 | complete in PR #61 at `c776db72d4f3a0e37b0be5004ac1a15141df14e8`; lifecycle projection, stale-status reconciliation and CI/session alignment verified |
...
| `PROFILE-NONWORKING-001` | HARDENING | Nonworking/between-jobs semantics/transitions. | PROFILE-003,SERVICE-001,ONBOARD-004 | queued |
...
| `SHOP-CORE-001` | PREREQUISITE | Deterministic shopping-intent reconciliation. | RECEIPT-001 | active in `M2-M0-018` / PR #72; core CI `33343292090` and release-wired CI `33343692494` green; fresh isolated Google active-create, zero-write replay, exact receipt-line fulfillment, receipt-immutability and terminal zero-write replay proof complete; final exact-head CI pending |
...
- `SHOP-CORE-001` is the one active work packet in `M2-M0-018`; PR #72 has direct/core CI, release-wired CI and fresh isolated Google create/replay/receipt-line fulfillment/receipt-immutability proof. It remains active and unmerged until final exact-head CI and protected merge complete.
