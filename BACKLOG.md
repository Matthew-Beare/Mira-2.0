...
| `AUTHORITY-MIGRATION-001` | PREREQUISITE | Staged provider/backend cutover without dual writable masters; parity/readback/recovery/rollback. | AUTH-001,STORE-001,BACKUP-001,AUTHORITY-REGISTRY-001,STORE-ADAPTER-001A | queued |
...
| `MIRA-SKILL-001` | PREREQUISITE | Full provider-neutral MIRA orchestration skill. | ONBOARD-007,DIST-STARTER-001,SOURCE-GATES-001,RUNTIME-ROUTER-001,SERVICE-COMPOSE-001 | queued; not M2-M0 minimal-client prerequisite |
| `PROVIDER-ONBOARD-001` | PREREQUISITE | Browser provider onboarding with exact resource/scope/readback. | PROVIDER-002,ONBOARD-006,RUNTIME-ROUTER-001 | queued |
| `GOOGLE-BOOTSTRAP-001` | PREREQUISITE | Full deterministic Personal Google blueprint/plan/verifier. | PROVIDER-003,MIRA-SKILL-001,PROVIDER-ONBOARD-001,SOURCE-GATES-001 | queued; not first Google adapter prerequisite |
| `NONTECH-INSTALL-001` | PREREQUISITE | Browser-only ordinary-user installation and exact readback. | ONBOARD-006,DIST-STARTER-001,SOURCE-GATES-001,MIRA-SKILL-001,PROVIDER-ONBOARD-001 | queued |
